...
<section class="food_section layout_padding-bottom">
    <div class="container">
      ...
      <div class="filters-content">
        <div class="row grid">
          <div class="col-sm-6 col-lg-4 all bouquet">
            <div class="box">
              <div>
                <div class="img-box">
          ...
          <div class="col-sm-6 col-lg-4 all vase">
            <div class="box">
              <div>
                <div class="img-box">
          ...
          <div class="col-sm-6 col-lg-4 all basket">
            <div class="box">
              <div>
                <div class="img-box">
          ...
          <div class="col-sm-6 col-lg-4 all artficial">
            <div class="box">
              <div>
                <div class="img-box">
